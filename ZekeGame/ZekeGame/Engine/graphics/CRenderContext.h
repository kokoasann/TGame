...
public:
	...
	*/
	void OMSetRenderTargets(unsigned int NumViews, RenderTarget* renderTarget[]);
	/*!
	...
	*/
	void OMGetRenderTargets(unsigned int& numViews, RenderTarget* renderTargets[MRT_MAX])
	{
		memcpy(renderTargets, m_renderTargetViews, sizeof(RenderTarget*)*m_numRenderTargetView);
	...
	*@param[in]	srv			SRV。
	*/
	void VSSetShaderResource(int slotNo, ShaderResouceView& srv)
	{
	...
	*@param[in]	srv			SRV。
	*/
	void PSSetShaderResource(int slotNo, ShaderResouceView& srv)
	{
	...
	*/
	void CSSetShaderResource(int slotNo, ShaderResouceView& srv)
	{
...
private:
	...
	RenderTarget*					m_renderTargetViews[MRT_MAX] = { nullptr };
